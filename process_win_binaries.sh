...
find eu4_downloader -type f -name '*win*.i64' -print0 | while IFS= read -r -d $'\0' binary; do
...
# Find all Mac binaries and process them
...
echo "All Win & Mac binaries processed."